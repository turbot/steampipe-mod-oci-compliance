...
control "cis_v110_2_3" {
  ...
  sql           = query.core_network_security_group_restrict_ingress_ssh_all.sql
...
control "cis_v110_2_4" {
  ...
  sql           = query.core_network_security_group_restrict_ingress_rdp_all.sql
...
control "cis_v110_2_5" {
  ...
  sql           = query.core_default_security_list_allow_icmp_only.sql
