...
- Renamed the following queries to correctly reference `security_group` based on the tables referenced: ([#47](https://github.com/turbot/steampipe-mod-oci-compliance/pull/47))
